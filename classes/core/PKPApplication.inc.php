...
abstract class PKPApplication implements iPKPApplicationInfoProvider {
	...
	public function getDAOMap() {
		return array(
			...
			'CustomFormDAO' => 'lib.pkp.classes.customForm.CustomFormDAO',
			'CustomFormElementDAO' => 'lib.pkp.classes.customForm.CustomFormElementDAO',
			'CustomFormResponseDAO' => 'lib.pkp.classes.customForm.CustomFormResponseDAO',
